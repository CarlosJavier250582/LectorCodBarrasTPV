    ...
    private void updateUI(FirebaseUser user) {
        ...
        if (user != null) {
            ...
            if(valida_status.equals("true)")){
                ...
                Intent activity__main = new Intent(getApplicationContext(), MainActivity.class);
                activity__main.putExtra("usuario",user.getEmail().toString());
                startActivity(activity__main);
